...
TOOL_SCHEMAS: dict = {
    ...
    "validate_arch":    '  validate_arch    — {{"path": str (default "DOCS/ARCH.json")}}\n'
                       '    # Validates the architecture contract. No LLM call — pure static check.\n'
                       '    # Returns ok/errors/summary. Safe to call repeatedly.',
...
{{
    ...
    def run_react(
        ...
        for iteration in range(1, max_iter + 1):
            ...
            _ARCH_PATTERNS = ("ARCH.md", "ARCH.json", "schema.sql", "models.py",
                               "schema.py", "config.py", "settings.py", "database.py")
